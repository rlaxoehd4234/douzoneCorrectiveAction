...
/**
 * @description : 시정조치파일 서비스
 * @Since : 2023/12/15
 * @Author : 박혜원, 제갈건, 이승현, 김태동
 * @History : 2023/12/15 최종 FIX
 */
...
public class AbcCommonService extends DzCometService {
		...
		try {
			...
			if (abcMultiFile_ds != null && abcMultiFile_ds.size() > 0) {
				...
				for (AbcFileModel file : abcMultiFile_ds) {
					...
					String filePath = file.getFile_atch_txt();
	...
	public void abcMultiFile_delete(
		...
		try {
			if (abcMultiFile_ds != null) {
				...
				String filePath = abcMultiFile_ds.getFile_atch_txt();
	         ...
	         if (abcImgFile_ds != null) {
	            if (!isDeleted) {
	               ...
	               if (imagePathDc == null || imagePathDc.equals("")) {
	                  ...
	                  deleteImageFile(abcImgFile_ds.getIdentifier());
	               }
   ...
   private void deleteImageFile(String identifier) {
	      try {
	         
	         HashMap<String, Object> param = new HashMap<String, Object>();
	         param.put("P_FILE_DC", identifier);
	         param.put("P_FILE_SQ", 1);
	         
	         HashMap<String, Object> param2 = new HashMap<String, Object>();
	         param2.put("P_IMAGE_PATH_DC", identifier);
